...
long t_tareByBle = 0;
bool b_tareByBle = true;
long t_tareStatus = 0;            //tare done time stamp
bool b_gyroEnabled = false;
...
float INPUTCOFFEEPOUROVER = 16.0;
