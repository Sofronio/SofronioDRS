...
#define PIN_BITMASK (BUTTON_PIN_BITMASK((gpio_num_t)BUTTON_TARE) | BUTTON_PIN_BITMASK((gpio_num_t)BUTTON_SET) | BUTTON_PIN_BITMASK((gpio_num_t)BATTERY_CHARGING))
  ...
  if (wakeup_reason == ESP_SLEEP_WAKEUP_EXT1) {
    ...
    switch (GPIO_reason) {
      case BUTTON_PIN_BITMASK(BATTERY_CHARGING):
        ...
        break;  // GPIO 27
      case BUTTON_PIN_BITMASK(BUTTON_TARE):
        GPIO_power_on_with = BUTTON_TARE;
        Serial.println("Only GPIO " + String(BUTTON_TARE));
        break;
      case BUTTON_PIN_BITMASK(BUTTON_SET):
        GPIO_power_on_with = BUTTON_SET;
        Serial.println("Only GPIO " + String(BUTTON_SET));
        break;                                                                                                                                                                                                                                 // GPIO 33
      case BUTTON_PIN_BITMASK(BATTERY_CHARGING) | BUTTON_PIN_BITMASK(BUTTON_TARE): Serial.println("Both GPIO " + String(BATTERY_CHARGING) + " + " + String(BUTTON_TARE)); break;                                                               // GPIO 27 + 32
      case BUTTON_PIN_BITMASK(BATTERY_CHARGING) | BUTTON_PIN_BITMASK(BUTTON_SET): Serial.println("Both GPIO " + String(BATTERY_CHARGING) + " + " + String(BUTTON_SET)); break;                                                                 // GPIO 27 + 33
      case BUTTON_PIN_BITMASK(BUTTON_TARE) | BUTTON_PIN_BITMASK(BUTTON_SET): Serial.println("Both GPIO " + String(BUTTON_TARE) + " + " + String(BUTTON_SET)); break;                                                                           // GPIO 32 + 33
      case BUTTON_PIN_BITMASK(BATTERY_CHARGING) | BUTTON_PIN_BITMASK(BUTTON_TARE) | BUTTON_PIN_BITMASK(BUTTON_SET): Serial.println("All GPIO " + String(BATTERY_CHARGING) + " + " + String(BUTTON_TARE) + " + " + String(BUTTON_SET)); break;  // GPIO 27 + 32 + 33
